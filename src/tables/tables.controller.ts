...
export class TablesController {
    ...
    @Get('waiter')
    @Roles(Role.WAITER)
    @ApiOperation({summary: "Obtener el listado de mesas asignadas al mesero que hace la petición, y las mesas disponibles en el restaurante"})
    findWaiterTables(@Req() req) {
        return this.tables.findWaiterTables(req.user.sub)
    }
